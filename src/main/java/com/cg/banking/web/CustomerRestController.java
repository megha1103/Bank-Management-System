...
public class CustomerRestController {
	...
	public String forgetPassword(@PathVariable("custid") String custId) throws CustomerException {
		Customer cust=service.forgetPassword(custId);
		return "Password has been sent to your registered mail";
	}
	
	@CrossOrigin
	@PostMapping("/changepassword")
	public String changePassword(@RequestParam("customerId") String custId, @RequestParam("oldpassword") String oldPass,@RequestParam("newpassword") String newPass) throws InvalidPasswordException {
		Customer cust=service.changePassword(custId,oldPass,newPass);
